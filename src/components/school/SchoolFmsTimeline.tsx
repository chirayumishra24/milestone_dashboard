        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Multi-wing FMS process pipeline (AY 2026–27)</p>
            </div>
          </div>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 mt-0.5">{w.students}</p>
                </div>
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${w.badgeColor}`}>
                  {w.badge}
                </span>
              </div>
              ...
              <div className="p-2.5 rounded-lg bg-white border border-slate-100 space-y-1.5">
                ...
                <p className="text-[11px] text-slate-500 italic mt-1">"{w.status}"</p>
              </div>
